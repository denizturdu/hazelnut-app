...
if not st.session_state.user:
    ...
    # =========================================================
    # MODÜL 1: ŞUBE ÜRÜN GİRİŞİ (SADECE FINDIK)
    # =========================================================
    if module == "1. Şube Ürün Girişi":
        st.title("Modül 1: Şube Ürün Girişi")
        st.info("Bu modül sadece Şubelerden yapılan Fındık alımları içindir.")
        
        # TAB YOK - DİREKT FINDIK FORMU
        ...
        with st.form("sube_hazelnut_form"):
            ...
            if st.form_submit_button("✅ Kaydet"):
                ...
                st.success("Şube Girişi Başarıyla Kaydedildi!")


    # ==========================
    # MODÜL 2: FABRİKA ÜRÜN GİRİŞİ (TABLI VERSİYON)
    # ==========================
