...
# ==========================================
    ...
    # ----------------------------------------------------------------
        ...
        st.sidebar.markdown("---")
        customer_menu = st.sidebar.radio("Müşteri Paneli", ["Piyasa Grafikleri", "Maliyet Hesaplayıcı"])
        
        if customer_menu == "Piyasa Grafikleri":
            st.title("📈 Piyasa Analizi")
            st.info("Günlük Fındık Fiyat Grafikleri yakında burada olacak.")
            
        elif customer_menu == "Maliyet Hesaplayıcı":
            st.title("🧮 Maliyet Hesaplayıcı")
            st.info("Özel maliyet hesaplama aracı yakında burada olacak.")
