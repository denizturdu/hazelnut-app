...
if not st.session_state.user:
    ...
    if module == "1. Şube Ürün Girişi":
        ...
        with st.form("sube_hazelnut_form"):
            ...
            # STANDART KABUKLU FORM (ŞUBE İÇİN BASİT FORM)
    ...
    # =========================================================
    # MODÜL 2: FABRİKA ÜRÜN GİRİŞİ (STANDARDIZE EDİLMİŞ FORM)
    # =========================================================
    if module == "2. Fabrika Ürün Girişi":
        ...
        with tab_findik:
            ...
            with st.form("fab_hazelnut_form"):
                ...
                st.markdown("---")
                # ------------------------------------------------------------
                # BÖLÜM 2: TEK TİP DETAYLI ANALİZ (HEM KABUKLU HEM İÇ İÇİN AYNI)
                # ------------------------------------------------------------
                ...
                # Etiket Kabuklu ise farklı, iç ise farklı görünebilir ama yapı aynı
                ...
                # EXTRA FIELDS FOR KABUKLU (Sadece Kabuklu seçiliyse göster)
                ...
                if reg_type == "Emanet":
                    ...
                    with cq2:
                        if hazelnut_cat == "Kabuklu Fındık":
                            ...
                            val_randiman = calculate_randiman(w_sample, w_good, w_shriv)
                            net_price_50 = price_gross / 1.0245
                            price_net_deducted = net_price_50 * (val_randiman / 50.0) # Actual Unit Price
